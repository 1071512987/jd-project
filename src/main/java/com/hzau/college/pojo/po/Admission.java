package com.hzau.college.pojo.po;

import com.baomidou.mybatisplus.annotation.TableName;
import lombok.Data;

@Data
@TableName("data_admissions")
...
//    private Integer provinceScore;
    ...
    // 专业总浏览量
    private Integer subjectViewTotal;

    private String collegeCode;

    private String collegeTypeName;

    private Short collegeEn985;

    private Short collegeEnDualClass;

    private Short collegeEn211;
    ...
    // 院校推荐权重排名
    private Double collegeWeightRank;

    // 院校推荐权重分数
    private Double weightScoreCollege;

    // 专业推荐权重分数
    private Double weightScoreSubject;
