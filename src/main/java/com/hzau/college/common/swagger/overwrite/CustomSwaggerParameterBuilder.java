package com.hzau.college.common.swagger.overwrite;//package com.hzau.college.common.swagger.overwrite;
//
...
//
///**
// * 自定义ExpandedParameterBuilderPlugin，主要是修正源码query传入请求参数position无效
// * 这里，将position赋值给order
// */
//@Primary
//@Component
