package com.hzau.college.common.foreign;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.service.IService;
import com.hzau.college.common.foreign.anno.ForeignCascade;
import com.hzau.college.common.foreign.anno.ForeignField;
import com.hzau.college.common.foreign.info.ForeignFieldInfo;
import com.hzau.college.common.foreign.info.ForeignTableInfo;
import com.hzau.college.common.util.Classes;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/qlu/college/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.hzau.college.service..*.remove*(..))")
    ...
    @Around("execution(* com.hzau.college.service..*.save*(..)) || execution(* com.hzau.college.service..*.update*(..)) ")
